...
<link type="text/css" rel="stylesheet" href="/end/css/bootstrap.min.css"/>
<link type="text/css" rel="stylesheet" href="/end/css/select2.min.css"/>

<script type="text/javascript" src="/end/js/jquery-1.7.1.js"></script>
<script type="text/javascript" src="/end/js/select2.js"></script>
